...
4. **Build, Run, and Debug:**
   ...
   - Continue (<kbd>F5</kbd>). You can connect to the server in the container by either: 
    ...
    - Notice port 5000 in the 'Ports' view is labeled "My Port." In `devcontainer.json`, you can set `"remote.portsAttributes"`, such as a label for your forwarded ports and the action to be taken when the port is autoforwarded.
